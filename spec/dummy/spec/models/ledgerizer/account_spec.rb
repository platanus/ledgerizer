...
module Ledgerizer
  describe Account, type: :model do
    ...
    describe "associations" do
      it { is_expected.to have_many(:lines).dependent(:destroy).inverse_of(:account) }
    end
    ...
    it_behaves_like "polymorphic attr", :ledgerizer_account, :accountable, :user, :client
    it_behaves_like "polymorphic attr", :ledgerizer_account, :tenant, :portfolio, :company
  end
end
